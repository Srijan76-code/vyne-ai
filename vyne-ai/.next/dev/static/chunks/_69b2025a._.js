...
"[project]/components/LaserFlow.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
`;
const LaserFlow = ({ className, style, wispDensity = 1, dpr, mouseSmoothTime = 0.0, mouseTiltStrength = 0.01, horizontalBeamOffset = 0.1, verticalBeamOffset = 0.0, flowSpeed = 0.35, verticalSizing = 2.0, horizontalSizing = 0.5, fogIntensity = 0.45, fogScale = 0.3, wispSpeed = 15.0, wispIntensity = 5.0, flowStrength = 0.25, decay = 1.1, falloffStart = 1.2, fogFallSpeed = 0.6, color = '#FF79C6' })=>{
    _s();
    ...
    const hasFadedRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(false);
    ...
    const baseDprRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(1);
    const currentDprRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(1);
    const fpsSamplesRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])([]);
    const lastFpsCheckRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(performance.now());
    const emaDtRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(16.7); // ms
    ...
    const inViewRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(true);
    const hexToRGB = (hex)=>{
        let c = hex.trim();
        if (c[0] === '#') c = c.slice(1);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "LaserFlow.useEffect": ()=>{
            ...
            geometry.setAttribute('position', new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$core$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["BufferAttribute"](new Float32Array([
                -1,
                -1,
                0,
                3,
            ...
            const mouseTarget = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$core$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Vector2"](0, 0);
            const mouseSmooth = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$core$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Vector2"](0, 0);
            const setSizeNow = {
                "LaserFlow.useEffect.setSizeNow": ()=>{
            ...
            const scheduleResize = {
                "LaserFlow.useEffect.scheduleResize": ()=>{
            ...
            const updateMouse = {
                "LaserFlow.useEffect.updateMouse": (clientX, clientY)=>{
            ...
            }["LaserFlow.useEffect.updateMouse"];
            const onMove = {
                "LaserFlow.useEffect.onMove": (ev)=>updateMouse(ev.clientX, ev.clientY)
            }["LaserFlow.useEffect.onMove"];
            const onLeave = {
                "LaserFlow.useEffect.onLeave": ()=>mouseTarget.set(0, 0)
            }["LaserFlow.useEffect.onLeave"];
            ...
            const onCtxLost = {
                "LaserFlow.useEffect.onCtxLost": (e)=>{
                    e.preventDefault();
                    pausedRef.current = true;
                }
            }["LaserFlow.useEffect.onCtxLost"];
            const onCtxRestored = {
                "LaserFlow.useEffect.onCtxRestored": ()=>{
            ...
            let raf = 0;
            const clamp = {
                "LaserFlow.useEffect.clamp": (v, lo, hi)=>Math.max(lo, Math.min(hi, v))
            }["LaserFlow.useEffect.clamp"];
            const dprFloor = 0.6;
            const lowerThresh = 50;
            const upperThresh = 58;
            let lastDprChangeRef = 0;
            const dprChangeCooldown = 2000;
            const adjustDprIfNeeded = {
                "LaserFlow.useEffect.adjustDprIfNeeded": (now)=>{
                    ...
                    const avgFps = samples.reduce({
                        "LaserFlow.useEffect.adjustDprIfNeeded": (a, b)=>a + b
                    }["LaserFlow.useEffect.adjustDprIfNeeded"], 0) / samples.length;
            ...
            }["LaserFlow.useEffect.adjustDprIfNeeded"];
            const animate = {
                "LaserFlow.useEffect.animate": ()=>{
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        fileName: "[project]/components/LaserFlow.tsx",
        lineNumber: 589,
        columnNumber: 10
...
_c = LaserFlow;
const __TURBOPACK__default__export__ = LaserFlow;
var _c;
__turbopack_context__.k.register(_c, "LaserFlow");
...
"[project]/sections/Chat/AiInputBox.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ai$2d$elements$2f$prompt$2d$input$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["PromptInputHeader"], {
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ai$2d$elements$2f$prompt$2d$input$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["PromptInputAttachments"], {
                    children: (attachment)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ai$2d$elements$2f$prompt$2d$input$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["PromptInputAttachment"], {
                            ...
                            fileName: "[project]/sections/Chat/AiInputBox.tsx",
                            lineNumber: 42,
                            columnNumber: 9
                        }, ("TURBOPACK compile-time value", void 0))
                }, void 0, false, {
                ...
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ai$2d$elements$2f$prompt$2d$input$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["PromptInputTools"], {
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ai$2d$elements$2f$prompt$2d$input$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["PromptInputSpeechButton"], {}, void 0, false, {
                                fileName: "[project]/sections/Chat/AiInputBox.tsx",
                                lineNumber: 57,
                                columnNumber: 7
                            }, ("TURBOPACK compile-time value", void 0)),
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ai$2d$elements$2f$prompt$2d$input$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["PromptInputButton"], {
                                children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ai$2d$elements$2f$prompt$2d$input$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["PromptInputModelSelect"], {
                                onValueChange: (value)=>{},
                                value: "gpt-4o",
                                children: [
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ai$2d$elements$2f$prompt$2d$input$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["PromptInputModelSelectTrigger"], {
                                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ai$2d$elements$2f$prompt$2d$input$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["PromptInputModelSelectValue"], {}, void 0, false, {
                                            fileName: "[project]/sections/Chat/AiInputBox.tsx",
                                            lineNumber: 64,
                                            columnNumber: 11
                                        }, ("TURBOPACK compile-time value", void 0))
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ai$2d$elements$2f$prompt$2d$input$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["PromptInputModelSelectContent"], {
                                        children: [
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ai$2d$elements$2f$prompt$2d$input$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["PromptInputModelSelectItem"], {
                                                value: "gpt-4o",
                                                children: "GPT-4o"
                                            }, void 0, false, {
                                                fileName: "[project]/sections/Chat/AiInputBox.tsx",
...
_c = AiInputBox;
var _c;
__turbopack_context__.k.register(_c, "AiInputBox");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
"[project]/sections/Hero/HeroBg.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/compiled/react/jsx-dev-runtime.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$LaserFlow$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/components/LaserFlow.tsx [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/compiled/react/index.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$sections$2f$Chat$2f$AiInputBox$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/sections/Chat/AiInputBox.tsx [app-client] (ecmascript)");
;
var _s = __turbopack_context__.k.signature();
"use client";
;
...
const HeroBg = ()=>{
    _s();
    const revealImgRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(null);
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                className: "h-3/4 opacity-85",
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$LaserFlow$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                    ...
                    fileName: "[project]/sections/Hero/HeroBg.tsx",
                    lineNumber: 31,
                    columnNumber: 9
                }, ("TURBOPACK compile-time value", void 0))
            }, void 0, false, {
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$sections$2f$Chat$2f$AiInputBox$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["AiInputBox"], {}, void 0, false, {
                    fileName: "[project]/sections/Hero/HeroBg.tsx",
                    lineNumber: 43,
                    columnNumber: 9
                }, ("TURBOPACK compile-time value", void 0))
...
_s(HeroBg, "09whRQ4n56z3yg2yQGcKQzSeSGk=");
_c = HeroBg;
const __TURBOPACK__default__export__ = HeroBg;
var _c;
...
//# sourceMappingURL=_69b2025a._.js.map