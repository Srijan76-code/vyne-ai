...
async function buildAndDeploy(webContainer) {
        ...
        for (const entry of entries){
            ...
            if (entry.isFile()) {
                ...
                if (relativePath.startsWith(`${outputDir.replace("/", "")}/`)) {
                    relativePath = relativePath.slice(outputDir.replace("/", "").length + 1);
                }
    ...
    console.log("🧱 Files ready for deploy:", filesList.map((f)=>f.path));
...
//# sourceMappingURL=_752844e3._.js.map