...
async function middleware(req) {
    ...
    try {
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$jose$2f$dist$2f$webapi$2f$jwt$2f$verify$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["jwtVerify"])(token, new TextEncoder().encode(process.env.JWT_SECRET));
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$esm$2f$server$2f$web$2f$exports$2f$index$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["NextResponse"].next();
    } catch (e) {
        const url = req.nextUrl.clone();
        url.pathname = "/auth/login";
...
const config = {
    matcher: [
        "/((?!_next/|api/auth/login|api/auth/signup|favicon.ico).*)"
    ]
};
}),
]);
