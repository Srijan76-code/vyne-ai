...
// Validate ../../../app/api/vyne/route.ts
{
  type __IsExpected<Specific extends RouteHandlerConfig<"/api/vyne">> = Specific
  const handler = {} as typeof import("../../../app/api/vyne/route.js")
  type __Check = __IsExpected<typeof handler>
  // @ts-ignore
  type __Unused = __Check
}
